          ...
          <div class="single-product">
            ...
            <div>
              ...
              <span id="stock_status">
                @if($product->stock <=0 && !sc_config('product_buy_out_of_stock')) {{ trans('product.out_stock') }} @else {{ trans('product.in_stock') }} @endif </span> </div> @endif {{--// Stock info --}} {{-- date available --}} @if (sc_config('product_available') && $product->date_available >= date('Y-m-d H:i:s'))
                  <div>
    ...
    <div class="tabs-custom tabs-horizontal tabs-line">
      ...
      <div class="nav-tabs-wrap">
        <ul class="nav-nav-tabs">
          <li class="nav-item">
            <a class="nav-link active">Seller Details</a>
          </li>
        </ul>
      </div>
      ...
      <div class="tab-content ">
        <div class="tab-pane fade show active">
          ...
          <div class="container">
            <div class="row">
              <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3" style="display: inline-block; height: 100%; vertical-align: middle; text-align: center;">
                <img src="{{ $user_details->avatar ? asset($user_details->avatar) : asset('admin/avatar/user.png') }} " width="80" height="80" class="img-circle " alt="User Image">
              </div>
              <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3" style="margin: auto;">
                <div class="" style="">
                  <b>Username:</b>
                </div>
                <div class="" style="">{{$user_details->username}}</div>
              </div>
              <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3" style="margin: auto;">
                <div class="" style=""><b>Phone Number:</b></div>
                <div class="" style="">{{$user_details->phone}}</div>
              </div>
              <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3" style="margin: auto;">
                <div class="" style=""><b>Email Address:</b></div>
                <div class="" style="">{{$user_details->email}}</div>
              </div>
            </div>
          </div>
        </div>
